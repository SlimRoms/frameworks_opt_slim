...
import static org.slim.service.display.LiveDisplayService.ALL_CHANGED;
import static org.slim.service.display.LiveDisplayService.DISPLAY_CHANGED;
import static org.slim.service.display.LiveDisplayService.MODE_CHANGED;
import static org.slim.service.display.LiveDisplayService.TWILIGHT_CHANGED;
...
import org.slim.service.display.LiveDisplayService.State;
...
public abstract class LiveDisplayFeature {
    ...
    protected final String getString(String setting) {
        return SlimSettings.System.getStringForUser(mContext.getContentResolver(),
                setting, UserHandle.USER_CURRENT);
    }

    protected final void putString(String setting, String value) {
        SlimSettings.System.putStringForUser(mContext.getContentResolver(),
                setting, value, UserHandle.USER_CURRENT);
    }
