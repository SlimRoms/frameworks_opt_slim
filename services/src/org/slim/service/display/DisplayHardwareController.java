...
import org.slim.hardware.LiveDisplayManager;
...
public class DisplayHardwareController extends LiveDisplayFeature {
    ...
    private static final Uri DISPLAY_AUTO_CONTRAST =
            SlimSettings.System.getUriFor(SlimSettings.System.DISPLAY_AUTO_CONTRAST);
    private static final Uri DISPLAY_COLOR_ADJUSTMENT =
            SlimSettings.System.getUriFor(SlimSettings.System.DISPLAY_COLOR_ADJUSTMENT);
    private static final Uri DISPLAY_COLOR_ENHANCE =
            SlimSettings.System.getUriFor(SlimSettings.System.DISPLAY_COLOR_ENHANCE);
    private static final Uri DISPLAY_CABC =
            SlimSettings.System.getUriFor(SlimSettings.System.DISPLAY_CABC);
    ...
    public DisplayHardwareController(Context context, Handler handler) {
        ...
        mDefaultCABC = mContext.getResources().getBoolean(
                org.slim.framework.internal.R.bool.config_defaultCABC);
        ...
        mDefaultColorEnhancement = mContext.getResources().getBoolean(
                org.slim.framework.internal.R.bool.config_defaultColorEnhancement);
        ...
        mDefaultAutoContrast = mContext.getResources().getBoolean(
                org.slim.framework.internal.R.bool.config_defaultAutoContrast);
    ...
    boolean isAutoContrastEnabled() {
        return mUseAutoContrast &&
                getBoolean(SlimSettings.System.DISPLAY_AUTO_CONTRAST, mDefaultAutoContrast);
    }
    ...
    boolean setAutoContrastEnabled(boolean enabled) {
        ...
        putBoolean(SlimSettings.System.DISPLAY_AUTO_CONTRAST, enabled);
        return true;
    }

    boolean isCABCEnabled() {
        return mUseCABC &&
                getBoolean(SlimSettings.System.DISPLAY_CABC, mDefaultCABC);
    }
    ...
    boolean setCABCEnabled(boolean enabled) {
        ...
        putBoolean(SlimSettings.System.DISPLAY_CABC, enabled);
        return true;
    }

    boolean isColorEnhancementEnabled() {
        return mUseColorEnhancement &&
                getBoolean(SlimSettings.System.DISPLAY_COLOR_ENHANCE,
    ...
    boolean setColorEnhancementEnabled(boolean enabled) {
        ...
        putBoolean(SlimSettings.System.DISPLAY_COLOR_ENHANCE, enabled);
        return true;
    }
    ...
    float[] getColorAdjustment() {
        ...
        if (!parseColorAdjustment(getString(SlimSettings.System.DISPLAY_COLOR_ADJUSTMENT), cur)) {
    ...
    private void saveColorAdjustmentString(final float[] adj) {
        ...
        putString(SlimSettings.System.DISPLAY_COLOR_ADJUSTMENT, sb.toString());
    }
