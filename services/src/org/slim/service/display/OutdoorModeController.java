...
public class OutdoorModeController extends LiveDisplayFeature {
    ...
    public OutdoorModeController(Context context, Handler handler) {
        ...
        mDefaultOutdoorLux = mContext.getResources().getInteger(
                org.slim.framework.internal.R.integer.config_outdoorAmbientLux);
        mDefaultAutoOutdoorMode = mContext.getResources().getBoolean(
                org.slim.framework.internal.R.bool.config_defaultAutoOutdoorMode);
    }
    ...
    public void onStart() {
        ...
        registerSettings(
                SlimSettings.System.getUriFor(SlimSettings.System.DISPLAY_AUTO_OUTDOOR_MODE));
    }
    ...
    boolean setAutomaticOutdoorModeEnabled(boolean enabled) {
        ...
        putBoolean(SlimSettings.System.DISPLAY_AUTO_OUTDOOR_MODE, enabled);
        return true;
    }

    boolean isAutomaticOutdoorModeEnabled() {
        return mUseOutdoorMode &&
                getBoolean(SlimSettings.System.DISPLAY_AUTO_OUTDOOR_MODE,
