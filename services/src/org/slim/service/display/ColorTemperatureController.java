...
import static org.slim.hardware.LiveDisplayManager.MODE_AUTO;
import static org.slim.hardware.LiveDisplayManager.MODE_DAY;
import static org.slim.hardware.LiveDisplayManager.MODE_NIGHT;
...
import org.slim.utils.MathUtil;
...
public class ColorTemperatureController extends LiveDisplayFeature {
    ...
    private static final Uri DISPLAY_TEMPERATURE_DAY =
            SlimSettings.System.getUriFor(SlimSettings.System.DISPLAY_TEMPERATURE_DAY);
    private static final Uri DISPLAY_TEMPERATURE_NIGHT =
            SlimSettings.System.getUriFor(SlimSettings.System.DISPLAY_TEMPERATURE_NIGHT);
    ...
    public ColorTemperatureController(Context context,
        ...
        mDefaultDayTemperature = mContext.getResources().getInteger(
                org.slim.framework.internal.R.integer.config_dayColorTemperature);
        mDefaultNightTemperature = mContext.getResources().getInteger(
                org.slim.framework.internal.R.integer.config_nightColorTemperature);

        mColorTemperatureRange = Range.create(
                mContext.getResources().getInteger(
                        org.slim.framework.internal.R.integer.config_minColorTemperature),
                mContext.getResources().getInteger(
                        org.slim.framework.internal.R.integer.config_maxColorTemperature));

        mColorBalanceCurve = MathUtil.powerCurve(
    ...
    private int mapColorTemperatureToBalance(int temperature) {
        double z = MathUtil.powerCurveToLinear(mColorBalanceCurve, temperature);
    ...
    int getDayColorTemperature() {
        return getInt(SlimSettings.System.DISPLAY_TEMPERATURE_DAY,
                mDefaultDayTemperature);
    }

    void setDayColorTemperature(int temperature) {
        putInt(SlimSettings.System.DISPLAY_TEMPERATURE_DAY, temperature);
    }

    int getNightColorTemperature() {
        return getInt(SlimSettings.System.DISPLAY_TEMPERATURE_NIGHT,
                mDefaultNightTemperature);
    }

    void setNightColorTemperature(int temperature) {
        putInt(SlimSettings.System.DISPLAY_TEMPERATURE_NIGHT, temperature);
    }
