...
import org.slim.hardware.ICMHardwareService;
...
public class CMHardwareService extends SlimSystemService implements ThermalUpdateCallback {
    ...
    public CMHardwareService(Context context) {
        ...
        publishBinderService(SlimServiceConstants.CM_HARDWARE_SERVICE, mService);
    }
    ...
    private final IBinder mService = new ICMHardwareService.Stub() {
        ...
        @Override
        public int getSupportedFeatures() {
            enforceHardwareAbstractionPermission();
        ...
        public boolean writePersistentBytes(String key, byte[] value) {
            mContext.enforceCallingOrSelfPermission(
                    org.slim.framework.Manifest.permission.MANAGE_PERSISTENT_STORAGE, null);
    ...
    private void enforceHardwareAbstractionPermission() {
        mContext.enforceCallingOrSelfPermission(
                    org.slim.framework.Manifest.permission.HARDWARE_ABSTRACTION_ACCESS, null);
    }
}
