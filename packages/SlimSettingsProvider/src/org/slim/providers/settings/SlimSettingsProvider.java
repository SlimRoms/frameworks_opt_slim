...
public class SlimSettingsProvider extends ContentProvider {
    ...
    private boolean mutateSystemSetting(String name, String value, int runAsUserId,
        ...
        if (!hasWriteSecureSettingsPermission()) {
            ...
            if (!SlimSettings.checkAndNoteWriteSettingsOperation(getContext(),
    ...
    private void enforceRestrictedSystemSettingsMutationForCallingPackage(int operation,
        ...
        switch (operation) {
            ...
            case MUTATION_OPERATION_UPDATE: {
                ...
                warnOrThrowForUndesiredSecureSettingsMutationForTargetSdk(name);
            } break;
    ...
    private static void warnOrThrowForUndesiredSecureSettingsMutationForTargetSdk(String name) {
    ...
    private static int getRequestingUserId(Bundle args) {
        final int callingUserId = (args != null) ? args.getInt(SlimSettings.CALL_METHOD_USER_KEY, UserHandle.getCallingUserId())
                : UserHandle.getCallingUserId();
        if (callingUserId == UserHandle.USER_CURRENT) {
