...
public class SlimSettingsSearchIndexablesProvider extends SearchIndexablesProvider {
    ...
    public Cursor queryXmlResources(String[] projection) {
        ...
        Collection<SearchIndexableResource> values = SlimSearchIndexableResources.values();
