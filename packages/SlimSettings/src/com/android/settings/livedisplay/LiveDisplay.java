...
import static org.slim.hardware.LiveDisplayManager.FEATURE_CABC;
import static org.slim.hardware.LiveDisplayManager.FEATURE_COLOR_ENHANCEMENT;
import static org.slim.hardware.LiveDisplayManager.FEATURE_DISPLAY_MODES;
...
public class LiveDisplay extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mModeEntries = res.getStringArray(
                org.slim.framework.internal.R.array.live_display_entries);
        mModeValues = res.getStringArray(
                org.slim.framework.internal.R.array.live_display_values);
        mModeSummaries = res.getStringArray(
                org.slim.framework.internal.R.array.live_display_summaries);
    ...
    protected int getMetricsCategory() {
        return SlimMetricsLogger.LIVE_DISPLAY;
    }
