...
public class DisplayTemperature extends DialogPreference {
    ...
    private class ColorTemperatureSeekBar implements SeekBar.OnSeekBarChangeListener {
        ...
        public ColorTemperatureSeekBar(SeekBar seekBar, TextView value) {
            ...
            if (mUseBalance) {
                mBalanceCurve = MathUtil.powerCurve(mMin, mConfig.getDefaultDayTemperature(), mMax);
        ...
        public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
            ...
            int displayValue;
            if (mUseBalance) {
                displayValue = roundUp(Math.round((float)MathUtil.linearToPowerCurve(
        ...
        public void setTemperature(int temperature) {
            if (mUseBalance) {
                double z = MathUtil.powerCurveToLinear(mBalanceCurve, (double)temperature);
        ...
        public int getTemperature() {
            if (mUseBalance) {
                return Math.round((float)MathUtil.linearToPowerCurve(
