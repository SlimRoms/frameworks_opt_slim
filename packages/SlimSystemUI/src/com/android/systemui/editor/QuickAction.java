...
public class QuickAction implements OnDismissListener {
    ...
    public void addActionItem(ActionItem action) {
        ...
        Log.d("TEST", "addAction - " + action.getTitle());
    ...
    public void show(View anchor) {
        ...
        Log.d("TEST", "mHidden window token - " + mHidden.getWindowToken());
        Log.d("TEST", "mContainer window token - " + mContainer.getWindowToken());
        Log.d("TEST", "anchor window token - " + anchor.getWindowToken());
