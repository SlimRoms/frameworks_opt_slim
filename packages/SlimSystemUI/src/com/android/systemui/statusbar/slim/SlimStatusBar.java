...
public class SlimStatusBar extends PhoneStatusBar {
    ...
    protected void bindGuts(ExpandableNotificationRow row) {
        ...
        final View killButton = View.inflate(mContext, R.layout.kill_button, null);
        ((LinearLayout) settingsButton.getParent()).addView(killButton,
                settingsButton.getParent().indexOfChild(settingsButton) /* index */);
        ...
        if (appUid >= 0) {
            ...
            if (infos.size() > 0) {
                ...
                appSettingsButton.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View v) {
                        SlimMetricsLogger.action(mContext, SlimMetricsLogger.ACTION_APP_NOTE_SETTINGS);
                    ...
                    public void onClick(View v) {
                        ...
                        killDialog.setPositiveButton(R.string.dlg_ok, new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                // kill pkg
                                ActivityManager actMan = (ActivityManager) mContext.getSystemService(
