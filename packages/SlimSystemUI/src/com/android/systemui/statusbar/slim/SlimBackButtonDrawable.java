...
public class SlimBackButtonDrawable extends Drawable {
    private final Drawable mWrappedDrawable;
    private float mRotation;
    private Animator mCurrentAnimator;

    private static final int ANIMATION_DURATION = 200;
    public static final Property<SlimBackButtonDrawable, Float> ROTATION
            = new FloatProperty<SlimBackButtonDrawable>("rotation") {
        @Override
        public void setValue(SlimBackButtonDrawable object, float value) {
            object.setRotation(value);
        }

        @Override
        public Float get(SlimBackButtonDrawable object) {
            return object.getRotation();
        }
    };

    public SlimBackButtonDrawable(Drawable wrappedDrawable) {
