...
public class RecentController implements RecentPanelView.OnExitListener,
    ...
    public RecentController(Context context, int layoutDirection) {
        ...
        mSlimSettingsManager.registerListener(new SettingsListener(), SETTINGS_URIS);
    }
    ...
    private class SettingsListener extends OnSettingsChangedListener {
        ...
        public void onChanged(String key, String value) {
            ...
            switch (key) {
                case SlimSettings.System.RECENT_PANEL_GRAVITY:
                    mUserGravity = TextUtils.isEmpty(value) ?
                            Gravity.RIGHT : Integer.parseInt(value);
                    setGravityAndImageResources();
                    break;
                case SlimSettings.System.RECENT_PANEL_SCALE_FACTOR:
                    float scaleFactor = (TextUtils.isEmpty(value) ?
                            100 : Integer.parseInt(value)) / 100.0f;
                ...
                case SlimSettings.System.RECENT_PANEL_EXPANDED_MODE:
                    mRecentPanelView.setExpandedMode(TextUtils.isEmpty(value) ?
                            RecentPanelView.EXPANDED_MODE_AUTO : Integer.parseInt(value));
                    break;
                case SlimSettings.System.RECENT_PANEL_SHOW_TOPMOST:
                    mRecentPanelView.setShowTopTask((TextUtils.isEmpty(value) ?
                            0 : Integer.parseInt(value)) == 1);
                    break;
                case SlimSettings.System.RECENT_SHOW_RUNNING_TASKS:
                    mRecentPanelView.setShowOnlyRunningTasks((TextUtils.isEmpty(value) ?
                            0 : Integer.parseInt(value)) == 1);
                    break;
                case SlimSettings.System.RECENT_PANEL_BG_COLOR:
                    mPanelColor = TextUtils.isEmpty(value) ? 0x0ffffff : Integer.parseInt(value);
