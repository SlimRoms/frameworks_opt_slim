...
public class RecentController implements RecentPanelView.OnExitListener,
    ...
    private static final String[] SETTINGS_URIS = {
    ...
    public RecentController(Context context, int layoutDirection) {
        ...
        // Settings listener
        SlimSettingsManager.getInstance().registerListener(
                new SettingsListener(mContext.getContentResolver()), SETTINGS_KEYS);
    }
