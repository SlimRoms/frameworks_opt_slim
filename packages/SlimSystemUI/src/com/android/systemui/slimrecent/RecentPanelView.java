...
public class RecentPanelView {
    ...
    public RecentPanelView(Context context, RecentController controller,
        ...
        mCardRecyclerView.setOnFlingListener(new RecyclerView.OnFlingListener() {
            @Override
            public boolean onFling(int velocityX, int velocityY) {
                if (DEBUG) Log.d("TEST", "x=" + velocityX + " : y=" + velocityY);
                return false;
            }
        });
    ...
    private void setupItemTouchHelper() {
        ItemTouchHelper touchHelper = new ItemTouchHelper(new ItemTouchHelper.Callback() {
            ...
            @Override
            public void onSelectedChanged(ViewHolder vh, int actionState) {
                super.onSelectedChanged(vh, actionState);
                if (DEBUG) Log.d("TEST", "onSelectedChanged");
            }
            ...
            public void onMoved (RecyclerView recyclerView,
                ...
                if (DEBUG) Log.d("TEST", "onMoved" + " : " + fromPos + " : " + toPos);
    ...
    protected void loadTasks() {
        Log.d("TEST", "loadTasks");
        Log.d("TEST", "isTasksLoaded() " + isTasksLoaded());
        Log.d("TEST", "mIsLoading=" + mIsLoading);
    ...
    private class CardLoader extends AsyncTask<Void, ExpandableCard, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            /*Not implemented for now, we are recycling on onPreExecute*/
            if (newSize < oldSize) {
