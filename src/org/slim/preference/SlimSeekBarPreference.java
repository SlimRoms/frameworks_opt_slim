...
public class SlimSeekBarPreference extends Preference
    ...
    protected View onCreateView(ViewGroup parent) {
        ...
        View layout = View.inflate(getContext(),
                org.slim.framework.internal.R.layout.slider_preference, null);

        monitorBox = (TextView)
                layout.findViewById(org.slim.framework.internal.R.id.monitor_box);
        bar = (SeekBar) layout.findViewById(org.slim.framework.internal.R.id.seek_bar);
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        ...
        if (progress == mSetDefault) {
            monitorBox.setText(org.slim.framework.internal.R.string.default_string);
